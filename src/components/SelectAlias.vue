    ...
    <v-card flat>
      ...
      <v-card-text>
        <v-row align="center" justify="center">
          <SelectAliasRow v-for="(num, index) in state.numberOfRows" :assigned-user-ids="assignedUserIds"
            :random-names="state.randomNames" :row-length="state.rowLength" :row=index
...
const emit = defineEmits(['alias-clicked', 'alias-selected'])
